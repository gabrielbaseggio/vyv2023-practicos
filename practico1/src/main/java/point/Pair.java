...
public class Pair<T1,T2> {
	  ...
	  /*@ public invariant first == null ||first!=null;
	   @*/
	
	private /*@ spec_public  @*/ T1 first; // first component of the ordered pair.
	private /*@ spec_public  @*/ T2 second; // second component of the ordered pair.
